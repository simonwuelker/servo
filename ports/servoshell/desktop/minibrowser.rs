...
impl Minibrowser {
    pub fn new(
        ...
        let context = EguiGlow::new(window, event_loop, event_loop_proxy, rendering_context.glow_gl_api(), None);
    ...
    pub(crate) fn handle_accesskit_event(&mut self, event: &accesskit_winit::WindowEvent) -> bool {
        ...
        match event {
            ...
            accesskit_winit::WindowEvent::ActionRequested(req) => {
                self.context.egui_winit.on_accesskit_action_request(req.clone());
                true
            }
