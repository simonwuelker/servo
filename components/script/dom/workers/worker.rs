...
impl WorkerMethods<crate::DomTypeHolder> for Worker {
    ...
    fn Constructor(
        ...
        // Step 2-4.
        let worker_url = match crate::url::parse_url(&compliant_script_url.str(), crate::url::RelativeTo::Global(&global)) {//global.api_base_url().join(&compliant_script_url.str()) {
            Ok(url) => url,
